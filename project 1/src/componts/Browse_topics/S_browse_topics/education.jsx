...
<Link to={'/aa'} className=" p-5  overflow-hidden">
            ...
            <img src={e_cardimg1} className="w-[100%]" />
                    ...
                    <div className="p-3  shadow-2xl  h-[500px] lg:h-[350px] min-w-[365px]  lg:w-[40%] rounded-3xl   flex flex-col justify-between hover:-translate-y-2 duration-1000 cursor-pointer">
                    <Link to={'/aa'} className=" p-5 z-10 overflow-hidden">
                    <div className="flex justify-between " >
