...
import img from '../../_images/img-6.png'
import img2 from '../../_images/img-7.png'
import img3 from '../../_images/img-8.png'
import img4 from '../../_images/map-icon.png'
import img5 from '../../_images/call-icon.png'
import img6 from '../../_images/mail-icon.png'
import img7 from '../../_images/fb-icon.png'
import img8 from '../../_images/twitter-icon.png'
import img9 from '../../_images/linkedin-icon.png'
import img10 from '../../_images/instagram-icon.png'
                ...
                <div className=' mt-10 flex flex-col lg:flex-row w-[100%] '>
                    ...
                    <div className=' w-[100%] lg:w-[30%]'>
                        <div className='flex p-3 '>
                            <Image className=' h-10 lg:h-auto  m-3 w-5' src={img4}/>
                            <p className='m-3 text-white text-lg lg:text-xl'>Page when looking at its layou</p>
                        </div>
                        <div className='flex p-3 '>
                            <Image className=' h-10 lg:h-auto   m-3 w-5' src={img5}/>
                            <p className='m-3 text-white text-lg lg:text-xl'>Call Now +01 123467890</p>
                        </div>
                        <div className='flex p-3 '>
                            <Image className=' h-10 lg:h-auto   m-3 w-6 ' src={img6}/>
                            <p className='m-3 text-white text-lg lg:text-xl'>demo@gmail.com</p>
                        </div>
                        <div className='flex p-3 '>
                            <Image className='m-3 w-6 ' src={img7}/>
                            <Image className='m-3 w-6 ' src={img8}/>
                            <Image className='m-3 w-6 ' src={img9}/>
                            <Image className='m-3 w-6 ' src={img10}/>
                        </div>
                        <form className=' '>
